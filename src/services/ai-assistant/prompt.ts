...
RECOMENDACIONES
Elegí solo entre los productos del CONTEXTO. Justificá con la característica documentada que los hace aptos.
...
const INTENT_HINTS: Record<string, string> = {
  ...
  RECOMMENDATION:
    "La consulta pide una recomendación: elegí 1 a 3 productos del CONTEXTO y justificá cada uno con la característica documentada que lo hace apto.",
  COMPATIBILITY:
