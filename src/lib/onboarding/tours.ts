...
export const ADMIN_ONBOARDING: OnboardingTour = {
  ...
  steps: [
    ...
    {
      id: "products-back-list",
      route: "/admin/products",
      target: "products-back-link",
      title: "Volvé al listado",
      body: "Para crear de cero necesitamos el listado, no la ficha. Tocá «Volver al catálogo» (arriba) o Catálogo → Productos en el menú.",
      requirePath: "/admin/products",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint:
        "hacé click en «Volver al catálogo» (resaltado) o en Productos del menú. El tutorial sigue cuando estés en el listado.",
      tip: "Estás dentro de un producto: el botón «Nuevo producto» está en el listado, no acá.",
    },
    {
      id: "products-new",
      route: "/admin/products",
      ...
      body: "En el listado, arriba a la derecha, tocá «Nuevo producto» para ver el alta vacía. Guardar crearía un producto real: en el tutorial solo observá y no guardes.",
      requirePath: "/admin/products/new",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint:
        "hacé click en el botón «Nuevo producto» resaltado (arriba a la derecha). El tutorial avanza al abrir el alta.",
    },
    {
    ...
    },
    {
      ...
      route: "/admin/quotes",
      target: "nav-link-quotes",
      title: "Volvé al listado de cotizaciones",
      body: "Para crear de cero hay que salir de esta cotización. Abrí Operación → «Cotizaciones» en el menú (o la fila de listado si ya estás cerca).",
      requirePath: "/admin/quotes",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint:
        "hacé click en «Cotizaciones» del menú (resaltado). El tutorial sigue cuando estés en el listado, no dentro de una cotización.",
      tip: "Los botones «Nueva» y «Rápida» están en el listado, no adentro del editor.",
    },
    {
      id: "quotes-new",
      route: "/admin/quotes",
      ...
      body: "En el listado, tocá «Nueva cotización». Vas a ver el alta previa (cliente, brief, tipo de documento). Crearla sí guarda un borrador: en el tutorial solo mirá el formulario y no confirmes la creación.",
      requirePath: "/admin/quotes/new",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint:
        "hacé click en el botón «Nueva cotización» resaltado. El tutorial avanza al abrir el alta.",
    },
    {
      id: "quotes-new-form",
    ...
    {
      id: "quotes-back-for-quick",
      route: "/admin/quotes",
      target: "nav-link-quotes",
      title: "Volvé al listado (otra vez)",
      body: "Si seguís en el alta completa, salí sin crear: abrí Operación → «Cotizaciones» para volver al listado. Ahí está el botón de cotización rápida.",
      requirePath: "/admin/quotes",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint:
        "hacé click en «Cotizaciones» del menú. El tutorial sigue cuando estés en el listado (no en /new ni dentro de una cotización).",
    },
    {
      id: "quotes-quick",
      route: "/admin/quotes",
      ...
      body: "En el listado, tocá «Cotización rápida». Es el atajo: cliente, referencia, plantilla, ítems y emitir/guardar en una pantalla.",
      requirePath: "/admin/quotes/quick",
      requirePathMode: "exact",
      autoAdvanceOnRoute: true,
      turnHint: "hacé click en el botón «Cotización rápida» resaltado.",
    },
    {
